...
<section class="content">
	...
	<form class="layui-form" action="/admin/products/productsMatchSave" role="form" id="matchForm">
	...
	<?php foreach($goodsList as $k => $v):?>
		<tr>
			<td>
				<input type="radio" name="productId" value="<?=$v->pid?>" />
			...
			<td><?=$matchMode[$v->is_import]?></td>
			<td><a href="javascript:;" class="delMatch">X</a></td>
		</tr>
		<?php endforeach;?>
	</table>
	...
	<script type="text/javascript">
		layui.use(['form','layer'], function () {
            ...
            form.on('submit(form_match)',function(data){
            	...
            	$.ajax({
	                type:'post',
	                url:"/admin/products/productsMatchSave",
	                data:data.field,
	                dataType:'json',
